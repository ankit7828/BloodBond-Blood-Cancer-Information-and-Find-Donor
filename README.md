...
- View Compatible Donor List
- Blood Cancer Information Portal
...
```bash
git clone [https://github.com/your-username/BloodBond.git](https://github.com/ankit7828/BloodBond-Blood-Cancer-Information-and-Find-Donor)
```
...
- Database Design
- Database-driven Matching Logic
